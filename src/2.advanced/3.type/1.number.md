...
<script>
  window.onload = () => {
    const oBox = document.getElementsByClassName("box2")[0]
    const fn = (ev) => {
      alert(ev)
    }
    oBox.addEventListener("touchmove", fn, false)
  }
</script>
```
...
<script>
  window.onload = () => {
    const oBox = document.getElementsByClassName("box3")[0]
    const fn = (ev) => {
      alert(ev)
    }
    oBox.addEventListener("tounchend", fn, false)
  }
</script>
```
...
<script>
  window.onload = () => {
    const oBox = document.getElementsByClassName("box4")[0]
    const fn = (ev) => {
      alert(ev)
    }
    oBox.addEventListener("touchcancel", fn, false)
  }
</script>
```
